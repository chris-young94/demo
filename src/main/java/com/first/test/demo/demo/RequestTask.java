        ...
        while (true) {
            ...
            while (true) {
                try {
                    ...
                    String result = httpClientUtils.getMessage();
                    int status = httpClientUtils.getCode();
                    ...
                    while (status == 502 || sta || status == 429) {
                        ...
                        if (status == 429) {
                            ...
                            Thread.sleep(6 * 60 * 1000); //每次间隔360秒
                        }
                    ...
                    if (status != 200) {
                        ...
                        if (counter.intValue() <= 1) {
                            ...
                            if (txhash.equals(null)) {
                                String txhash2 = new Transaction().transaction(s, address, credentials);
